import {
  ...
  taroWindowProvider
} from "./chunk-IPEBFHZR.js";
import {
  __commonJS
} from "./chunk-KJQ4BY7K.js";

// optional-peer-dep:__vite-optional-peer-dep:preact:@tarojs/plugin-framework-react
var require_plugin_framework_react = __commonJS({
  "optional-peer-dep:__vite-optional-peer-dep:preact:@tarojs/plugin-framework-react"() {
    throw new Error(`Could not resolve "preact" imported by "@tarojs/plugin-framework-react". Is it installed?`);
  }
});

// node_modules/.pnpm/@tarojs+plugin-framework-react@4.1.9_@tarojs+helper@4.1.9_@tarojs+runtime@4.1.9_@tarojs+share_kbgp2me7j6tibidtmd6vf7duli/node_modules/@tarojs/plugin-framework-react/dist/runtime.js
var reactMeta = {
  ...
  if (process.env.TARO_PLATFORM === "web") {
    hooks.tap("createPullDownComponent", (el, _, R, customWrapper) => {
      ...
      return R.forwardRef((props, ref) => {
        ...
        const refs = isReactComponent ? { ref } : {
          forwardedRef: ref,
...
function connectReactPage(R, id) {
  return (Page) => {
    ...
    return class PageWrapper extends R.Component {
      ...
      render() {
        const children = this.state.hasError ? [] : h$1(reactMeta.PageContext.Provider, { value: id }, h$1(Page, Object.assign(Object.assign({}, this.props), refs)));
        if (process.env.TARO_PLATFORM === "web") {
...
if (process.env.FRAMEWORK === "preact" && process.env.TARO_PLATFORM === "mini") {
  const options = require_plugin_framework_react().options;
...
//# sourceMappingURL=chunk-GPBRE76G.js.map
