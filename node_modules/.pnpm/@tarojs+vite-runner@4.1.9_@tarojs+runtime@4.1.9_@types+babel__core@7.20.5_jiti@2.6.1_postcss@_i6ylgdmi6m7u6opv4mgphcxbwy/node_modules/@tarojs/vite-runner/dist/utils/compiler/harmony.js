...
const ets_1 = require("../../harmony/ets");
...
class TaroCompilerContext extends base_1.CompilerContext {
    ...
    resolvePageImportPath(scriptPath, importPath) {
        const alias = this.taroConfig.alias;
        if ((0, helper_1.isAliasPath)(importPath, alias)) {
            importPath = (0, helper_1.replaceAliasPath)(scriptPath, importPath, alias);
        }
        return importPath;
    }
    collectNativeComponents(meta) {
        ...
        Object.entries(usingComponents).forEach(([compName, value]) => {
            ...
            const compScriptPath = (0, helper_1.resolveMainFilePath)(node_path_1.default.resolve(scriptPath, compPath));
    ...
    generateNativeComponent(rollupCtx, meta, implicitlyLoadedAfterOneOf = []) {
        if (meta.isGenerated || meta.isPackage)
            return;
        rollupCtx.emitFile({
            type: 'chunk',
            id: meta.templatePath + ets_1.QUERY_IS_NATIVE_SCRIPT,
            fileName: node_path_1.default.relative(this.sourceDir, meta.templatePath) + ets_1.QUERY_IS_NATIVE_SCRIPT,
